...
def select_language():
    selected_language = st.radio("Select Language", ["English", "Malay"])
...
def main_content(language_dict):
   ...
   # Get user input for an integer
    ...
    user_input_bil_wargaEmas = st.number_input(language_dict["input_bil_wargaEmas"], value=0, step=1, min_value=0, max_value=user_input_bil_air - user_input_bil_oku)
    ...
    user_input_bil_kanak2 = st.number_input(language_dict["input_bil_kanak2"], value=0, step=1, min_value=0, max_value=user_input_bil_air - user_input_bil_oku - user_input_bil_wargaEmas)
    ...
    st.write(f"{language_dict['predicted_expenditure']} {round(exp_selected_coefficient, 2)}")
